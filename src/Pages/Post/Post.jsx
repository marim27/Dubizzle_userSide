...
export default function Post() {
  ...
  //   console.log('saveImageArr',imgArr);
  // }
  ...
  //     console.log('removeImage',imgArr);
  ...
  function saveImageArr(eve) {
    ...
    setProduct({ ...product, images: [...imgArr, ...Array.from(eve.target.files)] });
  }
  ...
  function showImages(image) {
    try {
      ...
      return `${axiosInstanceProducts.defaults.baseURL}/${image}`;
    }
  }
  ...
  function handleSubmit(event) {
    ...
    if (hasErrors || isEmpty) {
      ...
      formData.append("contactMethod", product.contactMethod);
      ...
      const modifiedFormData = uploadFile(imgArr, formData);

      // Log the modified formData
  ...
  useEffect(() => {
    const sigleProduct = async () => {
      ...
      setProduct({
        ...
        description: res.data.single.description,
        price: res.data.single.price,
        currency: res.data.single.currency,
        images: res.data.single.images,
        condition: res.data.single.condition,
        locationid: res.data.single.locationid._id,
        sellerid: res.data.single.sellerid._id,
        Categoryid: res.data.single.Categoryid._id,
        subCategoryID: res.data.single.subCategoryID._id,
        Brand: res.data.single.Brand,
        Deliverable: res.data.single.Deliverable,
        PriceType: res.data.single.PriceType,
        phoneNumber: res.data.single.phoneNumber,
        // Chat: res.data.single.Chat,
        colorid: res.data.single.colorid,
        PaymentOption: res.data.single.PaymentOption,
        Transmission: res.data.single.Transmission,
        Video: res.data.single.Video,
        productStatus: "accept",
        contactMethod: res.data.single.contactMethod,
      });
      conditionActive(res.data.single.condition);
      radioActive(res.data.single.contactMethod);
      // setImgArr(res.data.single.images);
      // console.log(res.data.single.images);
      setImgArr(res.data.single.images);
  ...
  useEffect(() => {
    if (isActive == "Dubizzle Chat") {
      setProduct({ ...product, contactMethod: "Dubizzle Chat" });
      setErrors({ ...errors, ContactMethodError: "" });
    } else if (isActive == "Phone Number") {
      setProduct({ ...product, contactMethod: "Phone Number" });
      setErrors({ ...errors, ContactMethodError: "" });
    } else if (isActive == "Both") {
      setProduct({ ...product, contactMethod: "Both" });
      setErrors({ ...errors, ContactMethodError: "" });
    } else if (isActive == "") {
      setErrors({
        ...errors,
        ContactMethodError: "Please Choose One Only ... ! ",
      });
    }
  }, [isActive]);
          ...
          >
            <div className="card p-2 mb-4">
                ...
                <div className="d-flex">
                  <div className="d-flex flex-column col-4">
                    ...
                    <div className="m-2 d-flex align-items-end">
                      <input
                        className=""
                        checked={
                          product.PriceType == "Negotiable" ? true : false
                        }
                        id="Negotiable"
                        name="PriceType"
                        type="radio"
                    ...
                    <div className="m-2 d-flex align-items-end">
                      <input
                        className=""
                        checked={product.PriceType == "Exchange" ? true : false}
                        id="Exchange"
                        name="PriceType"
                        type="radio"
                        value="Exchange"
                    ...
                    <div className="m-2 d-flex align-items-end">
                      <input
                        className=""
                        checked={product.PriceType == "Free" ? true : false}
                        id="Free"
                        name="PriceType"
                        type="radio"
                        value="Free"
                  ...
                  <div className="d-flex flex-column">
                    ...
                    <div className="m-2 d-flex align-items-end">
                      <input
                        className=""
                        checked={product.PaymentOption == "Cash" ? true : false}
                        id="Cash"
                        name="PaymentOption"
                        type="radio"
                        value="Cash"
                    ...
                    <div className="m-2 d-flex align-items-end">
                      <input
                        className=""
                        checked={product.PaymentOption == "Visa" ? true : false}
                        id="Visa"
                        name="PaymentOption"
                        type="radio"
                        value="Visa"
                    ...
                    <div className="m-2 d-flex align-items-end">
                      <input
                        className=""
                        checked={product.PaymentOption == "Free" ? true : false}
                        id="PaymentFree"
                        name="PaymentOption"
                        type="radio"
                        value="Free"
                  ...
                  <div className="form-control border-0 pe-0 pt-3">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        value={user.given_name || user.username}
                      // onChange={(e) => validation(e)}
                      // onBlur={(e) => validation(e)}
                      />
                      <span className="invalid-feedback text-start">
              ...
              <div className="row px-4 border-bottom mb-4">
                ...
                <p className="mt-2 text-red">
                  <span>{errors.ContactMethodError}</span>
                </p>
              </div>
